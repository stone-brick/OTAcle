...
<template>
  <div class="flex flex-col flex-1 overflow-hidden bg-white dark:bg-slate-900/70 border-l border-r border-gray-100 dark:border-slate-800">
    <!-- Header -->
    ...
    <div class="flex-1 overflow-y-auto p-1.5 flex flex-col gap-1">
      ...
      <div
        ...
        class="text-center py-5 text-gray-400 dark:text-slate-500 text-sm"
      >
